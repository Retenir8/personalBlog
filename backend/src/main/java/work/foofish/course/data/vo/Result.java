...
public class Result {
    ...
    private static ResponseEntity<Result> build(Result result) {
    ...
    public static ResponseEntity<Result> success(Object data, String msg) {
        return build(new Result(200, msg, data));
    }
    ...
    public static ResponseEntity<Result> ok() {
        return build(new Result(200, "成功", null));
    }
    ...
    public static ResponseEntity<Result> error(Integer code, String msg) {
        return build(new Result(code, msg, null));
    }
