...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Result> handleMultipartException (org.springframework.web.multipart.MultipartException ex) {
     ...
     * 处理权限不足异常
     */
    @ExceptionHandler(work.foofish.course.exception.ForbiddenException.class)
    public ResponseEntity<Result> handleForbiddenException(work.foofish.course.exception.ForbiddenException ex) {
